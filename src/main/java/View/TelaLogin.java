...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createMatteBorder(8, 8, 8, 8, new java.awt.Color(0, 0, 0)));
        jPanel2.setPreferredSize(new java.awt.Dimension(700, 300));

        USUARIO.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        USUARIO.setForeground(new java.awt.Color(153, 51, 0));
        USUARIO.setText("NOME");

        CAMPOUSUARIO.setForeground(new java.awt.Color(153, 51, 0));

        SENHA.setBackground(new java.awt.Color(0, 0, 0));
        SENHA.setFont(new java.awt.Font("Segoe UI Black", 1, 18)); // NOI18N
        SENHA.setForeground(new java.awt.Color(153, 51, 0));
        SENHA.setText("SENHA");

        ACESSO.setFont(new java.awt.Font("Segoe UI Black", 1, 12)); // NOI18N
        ACESSO.setForeground(new java.awt.Color(153, 51, 0));
        ACESSO.setText("ACESSAR");
        ACESSO.setBorder(null);
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon("C:\\Users\\Devmat\\Documents\\Blue & Orange Simple Travel Agency Logo (4).png")); // NOI18N
                            ...
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(jPanel2Layout.createSequentialGroup()
                                        .addComponent(SENHA)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addComponent(CAMPOSENHA, javax.swing.GroupLayout.PREFERRED_SIZE, 218, javax.swing.GroupLayout.PREFERRED_SIZE)))
                                .addGap(70, 70, 70)))
    ...
    private void ACESSOActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ACESSOActionPerformed
        ...
        // Criando variável que recebe o retorno do método autenticar
        String senha = new String(CAMPOSENHA.getPassword()); // Agora pegamos a senha de JPasswordField
        Usuario logou = controller.authenticate(
          CAMPOUSUARIO.getText(), senha);
        
        if (logou != null) {
            JOptionPane.showMessageDialog(null, "Usuário logado com sucesso! " + logou.getNome());
            // Abrir a tela Home
            TelaHome telahome = new TelaHome(logou);
